...
//                .orElseThrow(() -> new InvalidRequestException("Todo not found"));
    ...
    public Page<TodoProjectionDto> search(int page, int size, String title, String nickname, LocalDateTime startDate, LocalDateTime endDate) {
        Pageable pageable = PageRequest.of(page - 1, size);
        return todoRepository.search(pageable, title, nickname, startDate, endDate);
    }
}
